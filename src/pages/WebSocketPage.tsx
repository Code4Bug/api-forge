...
export default function WebSocketPage() {
  ...
  const variables = useMemo(() => Object.fromEntries(workspace?.environments[0]?.variables.map((item) => [item.key, item.value]) ?? []), [workspace])
