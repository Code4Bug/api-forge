...
export default function HistoryPage() {
  ...
  function confirmClear() {
    if (history.length > 0 && window.confirm(`确认清空全部 ${history.length} 条历史记录吗？`)) {
      clearHistory()
