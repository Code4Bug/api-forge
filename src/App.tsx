...
function CursorMosaicGlow() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("api-forge:cursor-glow-change", sync);
  }, []);
  ...
  return enabled ? (
    <div ref={glowRef} className="cursor-mosaic-glow" aria-hidden="true">
      <span
        className="cursor-mosaic-glow-surface"
        data-effect={effect}
